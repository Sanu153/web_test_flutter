...
class MyCustomizedLineChart extends StatefulWidget {
  @override
...
class _MyColumnGraphState extends State<MyCustomizedLineChart> {
  @override
...
List<CustomLineSeries<_ChartData, DateTime>> getLineSeries() {
  final dynamic chartData = <_ChartData>[
    ...
    _ChartData(DateTime(2019, 5), 1.9),
    _ChartData(DateTime(2019, 6), 1.6),
    _ChartData(DateTime(2019, 7), 1.5),
    _ChartData(DateTime(2019, 8), 2.9),
    _ChartData(DateTime(2019, 10), 2.5),
  ];
